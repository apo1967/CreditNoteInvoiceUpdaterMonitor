package net._24t.cniupdatermonitor.config;
...
@Configuration
@EnableMongoRepositories("net._24t.cniupdatermonitor.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("net._24t.cniupdatermonitor.config.dbmigrations");
