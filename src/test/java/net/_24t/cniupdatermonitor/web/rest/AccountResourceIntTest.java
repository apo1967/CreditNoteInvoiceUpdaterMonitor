package net._24t.cniupdatermonitor.web.rest;

import net._24t.cniupdatermonitor.config.Constants;
import net._24t.cniupdatermonitor.CreditNoteInvoiceUpdaterMonitorApp;
import net._24t.cniupdatermonitor.domain.Authority;
import net._24t.cniupdatermonitor.domain.PersistentToken;
import net._24t.cniupdatermonitor.domain.User;
import net._24t.cniupdatermonitor.repository.AuthorityRepository;
import net._24t.cniupdatermonitor.repository.PersistentTokenRepository;
import net._24t.cniupdatermonitor.repository.UserRepository;
import net._24t.cniupdatermonitor.security.AuthoritiesConstants;
import net._24t.cniupdatermonitor.service.MailService;
import net._24t.cniupdatermonitor.service.dto.UserDTO;
import net._24t.cniupdatermonitor.web.rest.errors.ExceptionTranslator;
import net._24t.cniupdatermonitor.web.rest.vm.KeyAndPasswordVM;
import net._24t.cniupdatermonitor.web.rest.vm.ManagedUserVM;
import net._24t.cniupdatermonitor.service.UserService;
...
@SpringBootTest(classes = CreditNoteInvoiceUpdaterMonitorApp.class)
